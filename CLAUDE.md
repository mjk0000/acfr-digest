...
Coverage: **948/1100 fields (86.2%)**. 54 files complete (11/11), 43 partial, 3 zero
(Arkansas/Atlanta mojibake fast-bail, Orange County undiagnosed).
...
1. Diagnose Orange County (0/11, not mojibake).
2. OCR wiring for the hostile bucket: Arkansas, Atlanta (mojibake), San Antonio BS +
   Allegheny remainder (broken cmaps / glued tokens — need char-level work).
3. Re-triage the 27 partial files below 10/11 (NY State rotated text, Nebraska 3/11,
   Miami-Dade/Honolulu 5/11 are the big ones).
